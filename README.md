...
原生 macOS 桌面应用，用于监控[伊莉思](https://ylscode.com) Codex / AGI 套餐额度、使用情况、使用记录和本地 MCP 快照数据。应用提供状态栏入口、桌面仪表盘、套餐源切换、主题换肤、状态栏样式配置和本地 HTTP MCP 服务，方便用户和 AI Agent 获取当前账户状态。
